/decl/strata/base_planet
	...
	ores_sparse = list(
		/decl/material/solid/graphite = 100,
		/decl/material/solid/hematite = 200,
		/decl/material/solid/sand = 50,
		/decl/material/solid/sodiumchloride = 50,
		/decl/material/solid/pyrite = 100,
		/decl/material/solid/quartz = 50,
		/decl/material/solid/clay = 100,
		/decl/material/solid/magnetite = 100,
		/decl/material/solid/chalcopyrite = 200,
		/decl/material/solid/sphalerite = 50,
		/decl/material/solid/cassiterite = 50,
		/decl/material/solid/potash = 50,
		/decl/material/solid/potassium = 50,
		/decl/material/solid/cinnabar = 30,
		/decl/material/solid/spodumene = 30,
		/decl/material/solid/bauxite = 50
	)
	ores_rich = list(
		/decl/material/solid/metal/gold = 1,
		/decl/material/solid/metal/silver = 1,
		/decl/material/solid/hematite = 50,
		/decl/material/solid/graphite = 50,
		/decl/material/solid/pitchblende = 5,
		/decl/material/solid/chalcopyrite = 100,
		/decl/material/solid/tetrahedrite = 25,
		/decl/material/solid/wolframite = 25,
		/decl/material/solid/galena = 25,
		/decl/material/solid/bauxite = 25,
		/decl/material/solid/sperrylite = 25,
		/decl/material/solid/calaverite = 25,
		/decl/material/solid/ice/lukrite = 25,
		/decl/material/solid/ice/trigarite = 25,
		/decl/material/solid/ice/hydrogen = 25,
		/decl/material/solid/ice/hydrate/oxygen = 25,
		/decl/material/solid/ice/aspium = 25,
		/decl/material/solid/ice/ediroite = 25,
		/decl/material/solid/ice/trigarite = 25
	)
