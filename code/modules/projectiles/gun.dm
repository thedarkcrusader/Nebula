...
/obj/item/attachable
	...
	*/
	...
	var/silenced = 0
	var/original_caliber 		= null
	var/original_ammo_type 		= null
	var/caliber = null
	...
	var/obj/item/gun/projectile/master_gun

obj/item/attachable/attack(atom/A, mob/living/user, params)
	var/obj/item/gun/gun_to_attach = A
	if(istype(gun_to_attach))
		Attach(gun_to_attach, user)
	else
		return ..()


/obj/item/attachable/proc/Attach(obj/item/gun/projectile/gun_to_attach, mob/user)
	if(!istype(gun_to_attach))
		return //Guns only
...
/obj/item/gun/projectile/proc/update_attachables() //Updates everything. You generally don't need to use this.
	//overlays.Cut()
...
/obj/item/gun/projectile/proc/update_attachable(attachable) //Updates individually.
...
/obj/item/gun/projectile/proc/update_overlays(obj/item/attachable/A, slot)
	. = ..()
